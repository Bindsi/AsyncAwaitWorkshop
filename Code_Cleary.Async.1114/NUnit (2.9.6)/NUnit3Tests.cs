...
public class NUnit3Tests
{
    ...
    // Correctly fails under NUnit 2.9.6, due to an injected NUnit.Framework.AsyncSynchronizationContext.
    ...
    {
        // This workaround is necessary on Xamarin, which does not support async unit test methods.
        Task.Run(async () =>
        {
            await Task.Yield(); // Actual test code here.
